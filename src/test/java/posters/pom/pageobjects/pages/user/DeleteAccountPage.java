...
{
    private final SelenideElement deleteForm = $("#formDeleteAccount");

    private final SelenideElement passwordField = $("#password");

    private final SelenideElement deleteButton = $("#btnDeleteAccount");
    ...
    public void validateStructure()
    {
        ...
        $("label[for=\"password\"]").shouldBe(exactText(Neodymium.localizedText("AccountPages.password")));
    ...
    @Step("delete account")
    public HomePage deleteAccount(final String password)
    {
        // Password
