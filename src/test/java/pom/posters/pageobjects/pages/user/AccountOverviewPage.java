package pom.posters.pageobjects.pages.user;
...
import pom.posters.pageobjects.pages.browsing.AbstractBrowsingPage;
...
{
    private final SelenideElement headline = $("#titleAccountOverview");

    private final SelenideElement personalDataLink = $("#linkPersonalData");
    ...
    public void validateStructure()
    {
        ...
        // Order Overview Link
        // Make sure the link to the order history is there and the text starts with a
        // capital letter
        $("#linkOrderOverview").should(matchText("[A-Z].{3,}"));
        // My Addresses Link
        // Make sure the link to the Addresses page is there and the text starts with a
        // capital letter
        $("#linkAddressOverview").should(matchText("[A-Z].{3,}"));
        // Payment Settings Link
        // Make sure the link to the Credit Cards page is there and the text starts with
        // a capital letter
        $("#linkPaymentOverview").should(matchText("[A-Z].{3,}"));
        // Personal Data Link
        // Make sure the link to the Personal Data page is there and the text starts
