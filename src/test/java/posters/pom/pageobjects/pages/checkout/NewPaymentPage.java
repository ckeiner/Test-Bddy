...
{
    private final SelenideElement headline = $("#titlePayment");

    private final SelenideElement creditCardNumber = $("#creditCardNumber");

    private final SelenideElement creditCardName = $("#name");

    private final SelenideElement expirationMonth = $("#expirationDateMonth");

    private final SelenideElement expirationYear = $("#expirationDateYear");

    private final SelenideElement addPaymentButton = $("#btnAddPayment");
    ...
    public void validateStructure()
    {
        ...
        $("label[for=\"creditCardNumber\"]")
                .shouldHave(exactText(Neodymium.localizedText("General.payment.cardnumber")));
        ...
        // Expiration
        // Makes sure the label next to the expiration date fields shows the correct
        // text
        $("label[for=\"expirationDateMonth\"]")
                .shouldHave(exactText(Neodymium.localizedText("General.payment.expirationdate")));
    ...
    public PlaceOrderPlace sendPaymentForm(final String number, final String name, final String month,
            final String year)
    {
        // Credit Card Number
     ...
     * @return
     */
    public PlaceOrderPlace sendPaymentForm(final CreditCard creditcard)
    {
        return sendPaymentForm(creditcard.getCardNumber(), creditcard.getFullName(), creditcard.getExpDateMonth(),
                creditcard.getExpDateYear());
    }
}
