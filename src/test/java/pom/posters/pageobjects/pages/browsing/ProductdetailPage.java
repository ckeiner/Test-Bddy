...
{
    private final SelenideElement addToCartButton = $("#btnAddToCart");

    private final SelenideElement productName = $("#titleProductName");

    private final SelenideElement productPrice = $("#prodPrice");

    private final SelenideElement productSize = $("#selectSize");
    ...
    public void validateStructure()
    {
        ...
        // Title
        // Make sure we have the proper headline and it is not empty, at least 4
        // characters, starting with uppercase
        // letter,
        productName.shouldBe(matchText("[A-Z].{3,}"));
        // Price
        // Check that the price is correct in its form. A dollar symbol, followed by 1-3
        // digits, optionally more groups
        // of exactly 3 digits separated by a comma as separator, a period and 2 digits
        // for the cents as the end of the
        // String.
    ...
    public void validateProductName(final String name)
    {
        // Verify product name
    ...
    public void addToCart(final String size, final String style)
    {
        // Style
    ...
    {
        return new Product(getProductName(), getProductPrice(), getProductPrice(), getChosenStyle(), getChosenSize(),
                1);
    }
