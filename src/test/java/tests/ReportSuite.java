...
@RunWith(Suite.class)
@SuiteClasses({ GuestCheckout.class, FeatureTest.class, ReuseTest.class, ReuseTestdata.class, ScenarioTest.class,
        ExceptionThrowingTest.class, ConsumingCucumbers.class })
