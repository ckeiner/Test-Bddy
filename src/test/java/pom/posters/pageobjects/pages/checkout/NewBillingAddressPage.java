...
{
    private final SelenideElement headline = $("#titleBillAddr");
    ...
    private final SelenideElement addBillingButton = $("#btnAddBillAddr");
    ...
    public NewPaymentPage sendBillingAddressForm(final String name, final String company, final String address,
     ...
     * @return
     */
    public NewPaymentPage sendBillingAddressForm(final Address billingAddress)
    {
        return sendBillingAddressForm(billingAddress.getFullName(), billingAddress.getCompany(),
                billingAddress.getAddressLine(), billingAddress.getCity(), billingAddress.getState(),
                billingAddress.getZip(), billingAddress.getCountry());
    }
}
