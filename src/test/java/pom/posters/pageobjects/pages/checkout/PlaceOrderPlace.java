...
{
    private final SelenideElement headline = $("#titleOrderOverview");

    private final SelenideElement shippingAddressForm = $("#shippingAddr");

    private final SelenideElement billingAddressForm = $("#billingAddr");

    private final SelenideElement paymentForm = $("#payment");

    private final SelenideElement orderButton = $("#btnOrder");
    ...
    public void validateProduct(final int position, final String productName, final int productCount,
            final String productStyle, final String productSize)
    {
        final int index = position - 1;
        // Item info evaluation
        // The product at index @{index} exists
        final SelenideElement productContainer = $("#checkoutOverviewTable #product" + index);
    ...
    public void validateAddressesAndPayment(final Address shippingAddress, final Address billingAddress,
