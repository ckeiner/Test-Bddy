...
import posters.pom.pageobjects.pages.browsing.LoginPage;
import posters.pom.pageobjects.pages.browsing.RegisterPage;
import posters.pom.pageobjects.pages.user.AccountOverviewPage;
...
public class UserMenu extends AbstractComponent
{
    ...
    public void validateLoggedInName(final String firstName)
    {
        ...
        closeUserMenu();
        // Makes sure the mini menu element has the "logged" class active instead of the
        // "not-logged" class.
