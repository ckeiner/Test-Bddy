...
{
    private final SelenideElement headline = $("#titleDelAddr");

    private final SelenideElement nameField = $("#fullName");

    private final SelenideElement companyField = $("#company");

    private final SelenideElement addressField = $("#addressLine");

    private final SelenideElement cityField = $("#city");

    private final SelenideElement stateField = $("#state");

    private final SelenideElement zipField = $("#zip");

    private final SelenideElement countryField = $("#country");

    private final SelenideElement addShippingButton = $("#btnAddDelAddr");
     ...
     * @param country
     *            The country you want to use, currently only United States or
     *            Germany
     * @param sameBillingAddress
     *            Decision whether or not use the same billing address
     */
    @Step("fill and send new shipping address form")
    public NewBillingAddressPage sendShippingAddressForm(final String name, final String company, final String address,
            final String city, final String state, final String zip, final String country,
            final boolean sameBillingAddress)
    {
        // Name
        ...
        // Open the billing addresses or payment options page, depending on which radio
        // button you checked
        // Click on Continue
     ...
     * @return
     */
    public NewBillingAddressPage sendShippingAddressForm(final Address shippingAddress,
            final boolean sameBillingAddress)
    {
        return sendShippingAddressForm(shippingAddress.getFullName(), shippingAddress.getCompany(),
                shippingAddress.getAddressLine(), shippingAddress.getCity(), shippingAddress.getState(),
                shippingAddress.getZip(), shippingAddress.getCountry(), sameBillingAddress);
    }
}
